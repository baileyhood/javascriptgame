...
var beginGame = function()
{
    ...
    if (answer === '1' || answer === 'arnold' || answer === '1. arnold')
    {
        ...
        if (move === '1' || move === 'punch' || move === '1. punch')
        {
            ...
            {
                alert(
                    "Nice shot! But the T-1000 absorbed the bullet. He killed you. " +
                    losingMessage);
                beginGameAgain();
            }
            else if (secondMove === '2' || secondMove === 'run' ||
                secondMove === '2. run')
            {
                alert("Oh no! You couldn't outrun the T-1000. " + losingMessage);
                beginGameAgain();
            }
        ...
        else if (move === '2' || move === 'bodyslam' || move ===
            '2. bodyslam')
        {
            secondMove = prompt(
        ...
        else if (move === '3' || move === 'bitchslap' || move ===
            '3. bitchslap')
        {
            secondMove = prompt(
    ...
    //SYLVESTER CHOICE
    else if (answer === '2' || answer === 'sylvester' || answer ===
        '2. sylvester')
    {
        move = prompt(
        ...
        if (move === '1' || move === 'hook' || move === '1. hook')
        {
            ...
            if (secondMove === '1' || secondMove === "uppercut" ||
                secondMove === "1. uppercut")
            {
                alert(
            ...
            else if (secondMove === '3' || secondMove === "cartwhell" ||
                secondMove === "3. cartwhell")
            {
                alert(
        ...
        else if (move === '2' || move === 'jab' || move === '2. jab')
        {
            ...
            else if (secondMove === '2' || secondMove === "jab" ||
                secondMove === "1. jab")
            {
                alert(
            ...
            else if (secondMove === '3' || secondMove === "hook" ||
                secondMove === "3. hook")
            {
                alert(
            ...
            '3. straight punch')
        {
            ...
            if (secondMove === '1' || secondMove === "forfeit" ||
                secondMove === "3. forfeit")
            {
                alert(
            ...
            else if (secondMove === '3' || secondMove === "dance" ||
                secondMove === "3. dance")
            {
                alert(
    ...
    else if (answer === '3' || answer === 'bruce' || answer === '2. bruce')
    {
        ...
        if (move === '1' || move === 'kick' || move === '1. kick')
        {
            ...
            else if (secondMove === '3' || secondMove === "cry" ||
                secondMove === "3. cry")
            {
                alert(
        ...
        else if (move === '2' || move === 'nunchucks' || move ===
            '2. nunchucks')
        {
            secondMove = prompt(
            ...
            else if (secondMove === '2' || secondMove === "kick" ||
                secondMove === "1. kick")
            {
                alert(
                    "You did it! You defeated Norris with this finishing move." +
                    congratsMessage);
                    beginGameAgain();
            }
            else if (secondMove === '3' || secondMove === "push" ||
                secondMove === "3. push")
            {
                alert(
        ...
        else if (move === '3' || move === 'smack' || move === '3. smack')
        {
            ...
            else if (secondMove === '3' || secondMove === "play dead" ||
                secondMove === "3. play dead")
            {
                alert(
