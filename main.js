    ...
    {answer = prompt(choices.arnoldChoice).toLowerCase();
        ...
        if (answer === '1' || answer === 'punch' || answer === '1. punch')
        {
            answer = prompt(arnoldChoiceList.arnoldPunch).toLowerCase();
                  ...
                  if (answer === '1' || answer === 'shoot' || answer ===
                      '1. shoot')
                  {
                      alert(arnoldChoiceList.arnoldShoot + losingMessage);
                      beginGameAgain();
                  }
                  else if (answer === '2' || answer === 'run' ||
                      answer === '2. run')
                  {
                      alert(arnoldChoiceList.arnoldRun + losingMessage);
                      beginGameAgain();
                  }
                  else if (answer === '3' || answer === 'shake hands' ||
                      answer === "3. shake hands")
                  {
                      alert(arnoldChoiceList.arnoldShakeHands + congratsMessage);
                          beginGameAgain();
                  }
        }
        else if (answer === '2' || answer === 'bodyslam' || answer ===
            '2. bodyslam')
        {
            answer = prompt(arnoldChoiceList.arnoldBodySlam)
            .toLowerCase();
                  if (answer === '1' || answer === 'shoot' || answer ===
                      '1. shoot')
                  {
        ...
        else if (answer === '3' || answer === 'bitchslap' || answer ===
            '3. bitchslap')
        {
        ...
        '2. sylvester')
    {
        ...
        if (answer === '1' || answer === 'hook' || answer === '1. hook')
        {
            ...
            if (answer === '1' || answer === "uppercut" || answer === "1. uppercut")
                ...
                else if (answer === '2' || answer === "point away" ||
                    answer === "1. point away")
                {
                    alert( sylvesterChoiceList.sylvesterPointAway + congratsMessage);
                        beginGameAgain();
                }
                else if (answer === '3' || answer === "cartwheel" ||
                    answer === "3. cartwheel")
                {
        ...
        else if (answer === '3' || answer === 'straight punch' || answer ===
            '3. straight punch')
        {
            answer = prompt(sylvesterChoiceList.sylvesterStraightPunch).toLowerCase();
            if (answer === '1' || answer === "forfeit" ||
                answer === "1. forfeit")
            {
                alert(sylvesterChoiceList.sylvesterForfeit + losingMessage);
                    beginGameAgain();
            }
            else if (answer === '2' || answer === "counter moves" ||
                answer === "2. counter moves")
            {
    ...
    else if (answer === '3' || answer === 'bruce' || answer === '2. bruce')
    {
        ...
        if (answer === '1' || answer === 'kick' || answer === '1. kick')
        {
            answer = prompt(bruceChoiceList.bruceKick).toLowerCase();
                  if (answer === '1' || answer === "scream" || answer ===
                      "1. scream")
                  {
        ...
        else if (answer === '2' || answer === 'nunchucks' || answer === '2. nunchucks')
        {
            answer = prompt(bruceChoiceList.bruceNunchuck).toLowerCase();
                  ...
                  else if (answer === '2' || answer === "kick" ||
                      answer === "1. kick")
                  {
                      alert(bruceChoiceList.bruceKick2 + congratsMessage);
                          beginGameAgain();
                  }
                  else if (answer === '3' || answer === "push" ||
                      answer === "3. push")
                  {
        ...
        else if (answer === '3' || answer === 'smack' || answer === '3. smack')
        {
            answer = prompt(bruceChoiceList.bruceSmack).toLowerCase();
                  if (answer === '1' || answer === "dodge" || answer ===
                      "3. dodge")
                  {
                  ...
                  else if (answer === '3' || answer === "play dead" ||
                      answer === "3. play dead")
                  {
